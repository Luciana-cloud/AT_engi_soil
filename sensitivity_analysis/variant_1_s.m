% Monod kinetics-based model %

function vf_ = variant_1_s(t,x,p1,q)

%% STOCKS

CB       = x(1);  % Active bacteria A biomass [µg C/Kg]
...
vf_(1) = (CB)*(r_HY*Y)-m*Y*(CB-M);               % Bacteria Biomass [[µg C/Kg]]
